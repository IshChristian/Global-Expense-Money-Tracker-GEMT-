      ...
      <div class="main-content">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        <?php
                          ...
                          <td><a href="delete.php?table=budget&where=bu_id&id=<?php echo $result['bu_id'] ?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                              <?php
                              }
                            }
       ...
       <?php
        if(isset($_POST['btn'])){
          ...
          $sql = mysqli_query($con, "INSERT INTO setbudget (category,amount,period,days,user) VALUES ('$cat','$amnt','$per','$lon','$uid')");
          if($sql){
