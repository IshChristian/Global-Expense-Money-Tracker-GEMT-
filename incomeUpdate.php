  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <section class="section">
          <div class="section-header">
            <h1>Income</h1>
              ...
              <div class="card">
                  <form action="incomeUpdate.php" method="post" class="needs-validation" novalidate="">
      ...
      if(isset($_POST['btn'])){
        ...
        $sql = mysqli_query($con, "UPDATE income SET source='$src',amount='$amnt' WHERE user='$uid' AND in_id='$uid'");
        if($sql){
